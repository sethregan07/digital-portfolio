...
const Footer = () => {
  return (
    <footer className="mt-20 border-t border-border/80 pb-10 pt-14">
      <div className="container mx-auto max-w-5xl">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] lg:gap-16">
          {/* ── LEFT ── */}
          <div>
            <div className="mb-4 text-[2.2rem] font-semibold tracking-[-0.03em] text-foreground" style={editorialSerif}>
              Originalform
            </div>

            <p className="mb-6 max-w-sm text-[1.0625rem] font-light leading-8 text-muted-foreground">
          ...
          <div className="border-t border-border/60 pt-8 lg:border-l lg:border-t-0 lg:pl-10 lg:pt-0">
            ...
            <div className="mb-6 flex flex-col gap-3">
              {socialLinks.map(({ label, href }) => (
                ...
                >
                  <span className="text-[1rem] font-light leading-7 text-muted-foreground transition-colors group-hover:text-foreground">
                    {label}
                  </span>
            ...
            <div className="border-t border-border/60 pt-5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-[1rem] font-light leading-7 text-muted-foreground">{defaultAuthor.email}</span>
                <CopyButton
                  size="sm"
                  variant="ghost"
